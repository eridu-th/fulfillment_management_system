                        ...
                        >
                            ...
                            <template v-slot:form>
                                <form @submit.prevent>
                                    ...
                                    <div class="form-group">
                                        <label for="sender_postcode"
                                            >Sender Postcode</label
                                        >
                                        <input
                        ...
                        >
                            ...
                            <template v-slot:form>
                                <form @submit.prevent>
                                    ...
                                    <div class="form-group">
                                        <label for="receiver_postcode"
                                            >Receiver Postcode</label
                                        >
                                        <input
                                    ...
                                    <div class="form-group">
                                        ...
                                        />
                                        <div class="invalid-feedback">
                                            COD should be greater than or equal
                                            to 0
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="carrier_list"
                            ...
                            <template v-slot:form>
                                ...
                                >
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback">
                                            Please select a valid product in the
                                            options
                                        </div>
                                    </div>
                                    <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        addProduct(barcode_number = "") {
            const allProductIds = this.products.map(
                (item) => item.barcode_number
            );
